    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('one_time_token', models.CharField(blank=True, max_length=100, null=True, unique=True)),
                ('is_registered', models.BooleanField(default=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='qr_codes', to='api.user')),
            ],
        ),
    ]
